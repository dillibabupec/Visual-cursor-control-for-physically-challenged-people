...
import pyautogui as pag #for mouse controll
import imutils #for resize input frame
import dlib #for recognize face
import cv2 #accessing camera
...
while True:
    print(WINK_COUNTER,"WINK_COUNTER")
    print(WINK_CONSECUTIVE_FRAMES,"WINK_CONSECUTIVE_FRAMES")
